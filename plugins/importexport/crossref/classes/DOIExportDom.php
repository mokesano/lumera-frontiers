...
namespace Plugins\importexport\crossref\classes;
...
class DOIExportDom {
     ...
     * localized data.
     * @param $localizedData array An array of localized data (key: locale, value: localized data).
     * @param $localePrecedence array An array of locales by descending priority.
