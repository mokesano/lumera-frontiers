...
/**
 * @file core.Modules.tombstone/DataObjectTombstoneSettingsDAO.inc.php
 *
 ...
 * * REFACTORED: Wizdam Edition (PHP 8 Compatibility, Visibility, Typo Fix)
 */
    ...
    public function updateSetting($tombstoneId, $name, $value, $type = null, $isLocalized = false) {
        ...
        if (!$isLocalized) {
            ...
            if (is_array($value)) foreach ($value as $locale => $localeValue) {
                // WIZDAM FIX: Fixed variable typo $tombstone_id -> $tombstoneId
