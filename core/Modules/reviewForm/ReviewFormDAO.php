...
/**
 * @file core.Modules.reviewForm/ReviewFormDAO.inc.php
 *
...
import('core.Modules.reviewForm.ReviewForm');
...
class ReviewFormDAO extends DAO {
     ...
     */
    public function ReviewFormDAO() {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::ReviewFormDAO(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
        self::__construct();
    }
     ...
     * @return ReviewForm
     */
    public function getReviewForm($reviewFormId, $assocType = null, $assocId = null) {
     ...
     * @return array
     */
    public function getUseCounts($assocType, $assocId, $completion = null) {
     ...
     * @return ReviewForm
     */
    public function _returnReviewFormFromRow($row) {
        ...
        HookRegistry::dispatch('ReviewFormDAO::_returnReviewFormFromRow', array(&$reviewForm, &$row));
     ...
     * @return DAOResultFactory containing matching ReviewForms
     */
    public function getUsedByAssocId($assocType, $assocId, $rangeInfo = null) {
        $result = $this->retrieveRange(
            'SELECT    rf.*
            FROM    review_forms rf
     ...
     * @return DAOResultFactory containing matching ReviewForms
     */
    public function getUnusedByAssocId($assocType, $assocId, $rangeInfo = null) {
        $result = $this->retrieveRange(
            'SELECT    rf.*
            FROM    review_forms rf
            WHERE    rf.assoc_type = ? AND rf.assoc_id = ?
     ...
     * @return array
     */
    public function getTitlesByAssocId($assocType, $assocId, $used) {
     ...
     * @return int
     */
    public function getInsertReviewFormId() {
        return $this->getInsertId('review_forms', 'review_form_id');
    }

    /** DEPRECATED **/

    public function insertReviewForm($reviewForm) {
        if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
        $this->insertObject($reviewForm);
    }
    public function updateReviewForm($reviewForm) {
        if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
        $this->updateObject($reviewForm);
    }
    public function deleteReviewForm($reviewForm) {
        if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
        $this->deleteObject($reviewForm);
    }
    public function deleteReviewFormById($reviewFormId, $arg = null) {
        if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
