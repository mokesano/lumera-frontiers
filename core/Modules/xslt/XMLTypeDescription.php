...
class XMLTypeDescription extends TypeDescription {
     ...
     */
    public function XMLTypeDescription($typeName) {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::XMLTypeDescription(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
