...
class XSLTransformer {
    ...
    public $externalParameterSnippet;
    ...
    public function __construct() {
        ...
        $this->parameters = array(); // Initialize to avoid null issues
        $this->errors = array();
     ...
     */
    public function XSLTransformer() {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::XSLTransformer(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
        self::__construct();
    }
    ...
    public function _transformExternal($xml, $xmlType, $xsl, $xslType, $resultType) {
        ...
        // WIZDAM FIX: safe_mode is removed in PHP 8. We force escaping.
     ...
     * DOMDocument or string. Returns boolean "false" on error.
     */
    public function _transformPHP5($xml, $xmlType, $xsl, $xslType, $resultType) {
        // Prepare the XML DOM
