...
class Openurl10Nlm30CitationSchemaCrosswalkFilter extends Nlm30Openurl10CrosswalkFilter {
     ...
     */
    public function Openurl10Nlm30CitationSchemaCrosswalkFilter() {
     ...
     * locale when mapping.
     * @see Filter::process()
     * [WIZDAM FIX] Removed reference (&) on return and parameter
    ...
    public function process($input) {
        ...
        // [WIZDAM FIX] Removed reference on $propertyMap assignment
        $propertyMap = $this->nlmOpenurl10Mapping($publicationType, $input->getMetadataSchema(), $input);
     ...
     * @return array
     */
    public function _getOpenurl10GenreTranslationMapping() {
        static $openurl10GenreTranslationMapping = [
