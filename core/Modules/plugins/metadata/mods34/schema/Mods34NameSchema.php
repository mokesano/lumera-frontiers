...
class Mods34NameSchema extends MetadataSchema {
    ...
    public function __construct() {
        ...
        $this->addProperty('[@type]', [METADATA_PROPERTY_TYPE_VOCABULARY => 'mods34-name-types'], false, METADATA_PROPERTY_CARDINALITY_ONE, 'metadata.property.displayName.name-type', 'metadata.property.validationMessage.name-type', true);
        ...
        // use case for this.
        $this->addProperty('role/roleTerm[@type="code" @authority="marcrelator"]', [METADATA_PROPERTY_TYPE_VOCABULARY => 'mods34-name-role-roleTerms-marcrelator'], false, METADATA_PROPERTY_CARDINALITY_MANY);
    }

    /**
     * [SHIM] Backward Compatibility
     */
    public function Mods34NameSchema() {
