...
class CoreMods34Schema extends MetadataSchema {
    ...
    /**
     * Constructor
     * @param int|null $appSpecificAssocType
     * @param bool $useAuthoritiesForSubject whether the subject is
     * free text or controlled by vocabularies.
     */
    public function __construct($appSpecificAssocType = null, $useAuthoritiesForSubject = false) {
        // Configure the meta-data schema.
        $assocTypes = [ASSOC_TYPE_CITATION];
        ...
        $personResources = [
            [METADATA_PROPERTY_TYPE_COMPOSITE => ASSOC_TYPE_AUTHOR],
            [METADATA_PROPERTY_TYPE_COMPOSITE => ASSOC_TYPE_EDITOR]
        ];
        ...
        $this->addProperty('physicalDescription/form[@authority="marcform"]', [METADATA_PROPERTY_TYPE_VOCABULARY => 'mods34-physicalDescription-form-marcform']);
        ...
        if ($useAuthoritiesForSubject) {
            ...
            $topicType = [METADATA_PROPERTY_TYPE_VOCABULARY => 'mods34-subject-topic'];
            $geographicType = [METADATA_PROPERTY_TYPE_VOCABULARY => 'mods34-subject-geographic'];
            $temporalType = [METADATA_PROPERTY_TYPE_VOCABULARY => 'mods34-subject-temporal'];
        } else {
