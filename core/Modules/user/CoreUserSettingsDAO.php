...
/**
 * @file core.Modules.user/CoreUserSettingsDAO.inc.php
 *
...
class CoreUserSettingsDAO extends DAO {
     ...
     * @return array
     */
    public function getSettingsByAssoc($userId, $assocType = null, $assocId = null) {
        $userSettings = array();
