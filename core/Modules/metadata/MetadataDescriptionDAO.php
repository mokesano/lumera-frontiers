...
class MetadataDescriptionDAO extends DAO {
     ...
     */
    public function MetadataDescriptionDAO() {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::MetadataDescriptionDAO(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
        self::__construct();
    }
     ...
     */
    public function insertObject($metadataDescription) {
     ...
     */
    public function getObjectById($metadataDescriptionId) {
     ...
     * @param $assocType int
     * @param $assocId int
     * @param $rangeInfo DBResultRange the desired range
     * @return DAOResultFactory containing matching source descriptions (MetadataDescription objects)
     */
    public function getObjectsByAssocId($assocType, $assocId, $rangeInfo = null) {
     ...
     * @param $metadataDescription MetadataDescription
     */
    public function updateObject($metadataDescription) {
        $metadataSchema = $metadataDescription->getMetadataSchema();
     ...
     * @return boolean
     */
    public function deleteObject($metadataDescription) {
     ...
     * @return boolean
     */
    public function deleteObjectById($metadataDescriptionId) {
     ...
     * Changed to PUBLIC to match parent DAO class
     * @return int
     */
     ...
     * @return string
     */
    public function _resolveSchemaIdentifierToMetadataSchemaName($metadataSchemaId) {
        static $metadataSchemaMapping = array(
            'nlm30:nlm-3.0-element-citation' => 'core.Modules.plugins.metadata.nlm30.schema.Nlm30CitationSchema',
            'nlm30:nlm-3.0-name' => 'core.Modules.plugins.metadata.nlm30.schema.Nlm30NameSchema',
            'openurl10:openurl-1.0-journal' => 'core.Modules.plugins.metadata.nlm30.schema.Openurl10JournalSchema',
            'openurl10:openurl-1.0-book' => 'core.Modules.plugins.metadata.nlm30.schema.Openurl10BookSchema',
            'openurl10:openurl-1.0-dissertation' => 'core.Modules.plugins.metadata.nlm30.schema.Openurl10DissertationSchema'
        );
     ...
     * @return MetadataDescription
     */
    public function _newDataObject($metadataSchemaNamespace, $metadataSchemaName, $assocType) {
        // Removed & reference
     ...
     * @param $metadataDescription MetadataDescription
     */
    public function _updateObjectMetadata($metadataDescription) {
