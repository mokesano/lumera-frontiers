...
class MetadataProperty {
     ...
     */
    public function __construct($name, $assocTypes = array(), $allowedTypes = METADATA_PROPERTY_TYPE_STRING,
     ...
     */
    public function MetadataProperty($name, $assocTypes = array(), $allowedTypes = METADATA_PROPERTY_TYPE_STRING,
            $translated = false, $cardinality = METADATA_PROPERTY_CARDINALITY_ONE, $displayName = null, $validationMessage = null, $mandatory = false) {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::MetadataProperty(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
        self::__construct($name, $assocTypes, $allowedTypes, $translated, $cardinality, $displayName, $validationMessage, $mandatory);
    }
                    ...
                    switch ($testedType) {
                        case METADATA_PROPERTY_TYPE_COMPOSITE:
                            ...
                            switch(true) {
                                ...
                                // Modernized: replaced is_a() with instanceof
                                case ($value instanceof MetadataDescription):
                        ...
                        case METADATA_PROPERTY_TYPE_VOCABULARY:
                            ...
                            if (is_string($value)) {
                                ...
                                // Removed & from DAORegistry::getDAO
