...
class AuthorizationPolicy {
     ...
     * @param $message string
     */
    public function AuthorizationPolicy($message = null) {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::AuthorizationPolicy(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
    ...
    public function setAdvice($adviceType, $adviceContent) {
        // Removed & from parameter, advice content (usually string or simple array) doesn't need ref
    ...
    public function setAuthorizedContext(&$authorizedContext) {
        // Reference kept here to allow context sharing between policies
