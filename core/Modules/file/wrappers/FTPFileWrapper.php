...
/**
 * @file core.Modules.file/wrappers/FTPFileWrapper.inc.php
 *
...
class FTPFileWrapper extends FileWrapper {
    ...
    /** @var resource|null Control socket */
    public $ctrl;
     ...
     * @return boolean
     */
    public function _open($user, $pass, $path) {
     ...
     * @return int|boolean
     */
    public function _send($command, $data = '') {
     ...
     * @param $line string Reference to hold the line content
     * @return string|false Code (first 3 chars) or false
     */
    public function _receiveLine(&$line) {
        do {
