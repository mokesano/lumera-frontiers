...
class XmlWebService extends WebService {
     ...
     */
    public function XmlWebService() {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::XmlWebService(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
        self::__construct();
    }
     ...
     * @return DOMDocument|string|null the result of the web service or null in case of an error.
     */
    public function call($webServiceRequest) {
        ...
        if (is_null($xmlResult)) return null;
