...
class TypeDescription {
     ...
     */
    public function TypeDescription($typeName) {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::TypeDescription(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
     ...
     * @return boolean
     */
    public function isCompatible($object) { // Menghilangkan reference (&)
     ...
     * @return boolean
     */
    public function checkType($object) { // Menghilangkan reference (&)
        // Must be implemented by subclasses
        assert(false);
    }
     ...
     * @return boolean
     */
    protected function _parseTypeNameInternally($typeName) { // Menggunakan protected
