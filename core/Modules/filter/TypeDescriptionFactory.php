...
class TypeDescriptionFactory {
     ...
     */
    public function TypeDescriptionFactory() {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::TypeDescriptionFactory(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
        self::__construct();
    }
     ...
     */
    public static function getInstance() { // Menggunakan static dan menghapus reference (&)
        // Menghapus reference (&) pada penugasan
        ...
        return $instance; // Menghapus reference (&)
    }
     ...
     */
    public function instantiateTypeDescription($typeDescription) { // Menghapus reference (&)
        $nullVar = null;
        ...
        // Menghapus reference (&) pada instantiate
        ...
        return $typeDescriptionObject; // Menghapus reference (&)
    }
