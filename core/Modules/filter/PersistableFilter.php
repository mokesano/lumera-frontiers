...
class PersistableFilter extends Filter {
    ...
    public function __construct($filterGroup) {
        ...
        $this->_filterGroup = $filterGroup; // Menghapus reference (&)
     ...
     * @param $filterGroup FilterGroup
     */
    public function PersistableFilter($filterGroup) {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::PersistableFilter(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
    ...
    public function getFilterGroup() {
        return $this->_filterGroup; // Menghapus reference (&)
    }
     ...
     */
    public function addSetting($setting) { // Menghapus reference (&) pada parameter
        ...
        $this->_settings[$settingName] = $setting; // Menghapus reference (&)
    }
     ...
     */
    public function getSetting($settingName) { // Menghapus reference (&) pada return
        assert(isset($this->_settings[$settingName]));
     ...
     */
    public function getSettings() { // Menghapus reference (&) pada return
     ...
     * @return array
     */
    public function getLocalizedSettingNames() { /* @var $setting FilterSetting */
     ...
     * @return array
     */
    protected function getInternalSettings() {
