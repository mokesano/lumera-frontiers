...
class ClassTypeDescription extends TypeDescription {
     ...
     */
    public function ClassTypeDescription($typeName) {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::ClassTypeDescription(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
