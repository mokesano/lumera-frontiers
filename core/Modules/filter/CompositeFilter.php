...
class CompositeFilter extends PersistableFilter {
     ...
     */
    public function CompositeFilter($filterGroup, $displayName = null) {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::CompositeFilter(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
     ...
     *
     * @param $filter Filter
     * @return integer|null the filter's sequence number, null
    ...
    public function _resolveCompositeSettingName($compositeSettingName) {
        ...
        // Return the result.
        // NOTE: References (&) removed for PHP 7/8 object compatibility
